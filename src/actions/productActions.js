...
export const createProduct = () => async (dispatch, getState) => {
  try {
    ...
    const { data } = await axios.post(`${import.meta.env.VITE_BACKEND_URL}/api/products`, {}, config)
...
export const createProductReview = (productId, review) => async (
  ...
  try {
    ...
    await axios.post(`${import.meta.env.VITE_BACKEND_URL}/api/products/${productId}/reviews`, review, config)
...
export const listTopProducts = () => async (dispatch) => {
  try {
    ...
    const { data } = await axios.get(`${import.meta.env.VITE_BACKEND_URL}/api/products/top`)
